...
public class Assignment67 {
	...
	public static void main(String[] args) {
		...
		String str = assignment67.splitString("Hi Hello Maulik");
		System.out.println(str);
		String str2 = assignment67.initialCapital("hi hEllO how are you");
		System.out.println(str2);
		String str3 = assignment67.initialCapitalReverse("Hi Hello Maulik");
